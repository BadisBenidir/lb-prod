      ...
      <div className="p-3 flex flex-col h-32"> {/* Fixed height container */}
        ...
        <button
          ...
          className={`w-full py-2 text-xs font-bold rounded-xl transition-all duration-300 shadow-sm ${
            product.inStock && !product.isSoldDisplay
              ? 'bg-gradient-to-r from-black to-gray-800 text-white hover:from-gray-800 rounded-xl hover:to-gray-700 hover:shadow-md transform hover:scale-[1.02] active:scale-[0.98]'
              : 'bg-gray-200 text-gray-400 rounded-xl cursor-not-allowed'
          }`}
        >
