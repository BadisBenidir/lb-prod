            ...
            {values.map((value) => (
              <div key={value.title} className="bg-white p-8 rounded-xl shadow-lg border border-gray-100 group hover:shadow-xl transition-all duration-300">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="block md:hidden text-l font-semibold text-gray-900">{value.title}</h3>
                  <h3 className="hidden md:block text-2xl font-semibold text-gray-900">{value.title}</h3>
                </div>
                <p className="block md:hidden text-gray-600 leading-relaxed text-m">{value.description}</p>
                <p className="hidden md:block text-gray-600 leading-relaxed text-lg">{value.description}</p>
              </div>
            ))}
          </div>
        </div>
