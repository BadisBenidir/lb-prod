...
const AlreadyInCartModal: React.FC<AlreadyInCartModalProps> = ({
  isOpen,
  onClose,
  product,
  onViewCart
        ...
        <div className="bg-white rounded-lg shadow-xl max-w-md w-full transform transition-all">
          ...
          <div className="flex items-center justify-between p-4 border-b">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-lg font-semibold">Article déjà présent</h3>
            </div>
            <button 
              onClick={onClose}
          ...
          <div className="p-4">
            ...
            <p className="text-sm text-gray-600 mt-4">
              Cet article est déjà présent dans votre panier. Chaque article est unique et ne peut être ajouté qu'une seule fois.
            </p>
          </div>
