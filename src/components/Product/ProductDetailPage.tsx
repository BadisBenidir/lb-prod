        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="space-y-6">
            ...
            <div ref={atcRef} className='md:hidden mt-6 mb-6'>
              {/* Actions */}
              <div className="bg-white p-4 -mx-4 mt-8 mb-6">
            ...
            {defectImages?.length > 0 && (
              <details className='mb-4 rounded-xl'>
                <summary className='list-none cursor-pointer w-full'>
                  ...
                  <span>Photos complémentaires – État & Défauts</span>
                  </div>
                </summary>
            ...
            {/* Actions */}
            <div className="hidden md:block sticky bottom-0 bg-white border-t border-gray-200 p-4 -mx-4 mt-8">
              {/* Message pour produit vendu affiché */}
              {product.isSoldDisplay && (
                <div className="mb-4 bg-gray-100 border border-gray-300 p-3 rounded-lg text-center">
                  <p className="text-gray-700 font-medium">Ce produit a été vendu</p>
