        ...
        <div>
          ...
          <div className="flex flex-wrap items-center gap-2 md:gap-4 mb-4">
            <span className={`px-2 py-1 text-xs font-medium rounded ${
              product.condition === 'Neuf' ? 'bg-blue-100 text-blue-800' :
              product.condition === 'Excellent' ? 'bg-green-100 text-green-800' :
              product.condition === 'Très Bon' ? 'bg-yellow-100 text-yellow-800' :
              product.condition === 'Bon' ? 'bg-orange-100 text-orange-800' :
