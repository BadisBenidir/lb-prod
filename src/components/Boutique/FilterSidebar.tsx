...
const FilterSidebar: React.FC<FilterSidebarProps> = ({
  ...
  return (
    <>
      ...
      <div className={`fixed lg:relative top-16 lg:top-0 left-0 h-[calc(100vh-4rem)] lg:h-full w-80 bg-white border-r border-gray-200 z-10 transform transition-transform duration-300 ${
